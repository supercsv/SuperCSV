...
// ValidateDatetime validates ISO 8601 datetime WITHOUT timezone using position-based checks.
...
func ValidateDatetime(b []byte) bool {
	n := len(b)
...
func DatetimeError() string {
	return "invalid datetime format (expected ISO 8601 without timezone)"
}
